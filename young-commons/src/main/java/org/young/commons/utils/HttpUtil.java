...
import org.young.commons.utils.HttpUtil.FormField.FormFieldType;
...
public class HttpUtil {
	...
	private static CloseableHttpClient defaultHttpClient = initHttpClient(connectionTimeout/1000, socketTimeout/1000);
	/**
	 * 初始化http client
				...
				for (FormField field : formFields) {
					...
					case InputStream:
						...
						strBuf.append("Content-Disposition: form-data; name=\"" + name + "\"; filename=\""
								+ (file==null?field.getOrignFilename():file.getName()) + "\"\r\n");
						...
						out.write(strBuf.toString().getBytes("UTF-8"));
						InputStream inputStream = field.getType()==FormFieldType.InputStream? field.getInputStream():new FileInputStream(file);
